...
DEPENDS = "alsa-lib zlib libogg yasm-native rockchip-mpp"

inherit autotools pkgconfig

PACKAGECONFIG ??= "avdevice avfilter avcodec avformat swresample swscale postproc \
                   bzlib gpl lzma theora x264 \
                   ${@bb.utils.contains('DISTRO_FEATURES', 'x11', 'x11 xv', '', d)} rkmpp"

PACKAGECONFIG[rkmpp] = "--enable-rkmpp,--disable-rkmpp"
